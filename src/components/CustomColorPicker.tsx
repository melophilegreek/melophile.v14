  ...
  return (
    <div className="select-none">
      ...
      <div
        ...
        style={{
          touchAction: 'none',
          backgroundImage: 'linear-gradient(to top, #000, rgba(0,0,0,0)), linear-gradient(to right, #fff, rgb(var(--fg-rgb) / 0))',
      ...
      >
        <div
          className="absolute w-5 h-5 rounded-full border-2 border-fg pointer-events-none"
          style={{
            left: `${hsv.s * 100}%`,
            top: `${(1 - hsv.v) * 100}%`,
      ...
      >
        <div
          className="absolute top-1/2 w-5 h-5 rounded-full border-2 border-fg pointer-events-none"
          style={{
            left: `${(hsv.h / 360) * 100}%`,
            transform: 'translate(-50%, -50%)',
            background: hueColor,
